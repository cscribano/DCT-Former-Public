...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_wiki", help="input directory with sharded text files", required=True)
    parser.add_argument("--data_corpus", help="input directory with sharded text files", required=True)
    ...
    wiki_files = list_files_in_dir(args.data_wiki, file_name_grep=args.grep)
    corpus_files = list_files_in_dir(args.data_corpus, file_name_grep=args.grep)

    dataset_files = wiki_files + corpus_files
