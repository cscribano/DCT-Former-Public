...
def get_scheduler(cnf, optimizer):
    # type: (Conf, torch.nn.Module) -> torch.nn.Module
    curver = eval(cnf.lr_scheduler.curve)(cnf.lr_scheduler.args)
    scheduler = eval(cnf.lr_scheduler.scheduler)(cnf.lr_scheduler.args, cnf.experiment)
